    ...
    private function seedCoreData(CarbonImmutable $now): array
    {
        $roleIds = [
            'super_admin' => DB::table('fg_roles')->insertGetId([
                ...
                'permissions' => json_encode(['users:*', 'roles:*', 'repos:*', 'jobs:*', 'settings:*', 'customers:*'], JSON_THROW_ON_ERROR),
                'scope' => 'system',
                'created_at' => $now,
                'updated_at' => $now,
            ]),
        ...
        $settingIds = [
            'admin' => DB::table('fg_user_settings')->insertGetId([
                ...
                'force_actions_json' => json_encode(["change_password"], JSON_THROW_ON_ERROR),
            ...
            'operator' => DB::table('fg_user_settings')->insertGetId([
                ...
                'force_actions_json' => json_encode([], JSON_THROW_ON_ERROR),
